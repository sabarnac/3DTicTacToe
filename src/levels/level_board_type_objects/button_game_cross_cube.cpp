# ifndef TTT3D_LEVEL_BOARD_TYPE_BUTTON_CROSS_CUBE

	# define TTT3D_LEVEL_BOARD_TYPE_BUTTON_CROSS_CUBE 1
	...
	class levelBoardTypeButtonCrossCube : public levelBoardTypeButtonBase {

		public:

			levelBoardTypeButtonCrossCube ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardTypeButtonBase ( "button-cross-cube-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardTypeButtonCrossCube : Initializing cross cube button" ) ;
				...
				this -> logger -> logInfo ( "levelBoardTypeButtonCrossCube : Initialized cross cube button\n" ) ;
			}
