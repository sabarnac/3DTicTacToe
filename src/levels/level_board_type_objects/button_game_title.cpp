# ifndef TTT3D_LEVEL_BOARD_TYPE_BUTTON_TITLE

	# define TTT3D_LEVEL_BOARD_TYPE_BUTTON_TITLE 1
	...
	class levelBoardTypeGameTitle : public levelBoardTypeButtonBase {

		public:

			levelBoardTypeGameTitle ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardTypeButtonBase ( "game-title" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardTypeGameTitle : Initializing game title button" ) ;
				...
				this -> logger -> logInfo ( "levelBoardTypeGameTitle : Initialized game title button\n" ) ;
			}
