# ifndef TTT3D_LEVEL_BOARD_TYPE_BUTTON_FULL_CUBE

	# define TTT3D_LEVEL_BOARD_TYPE_BUTTON_FULL_CUBE 1
	...
	class levelBoardTypeButtonFullCube : public levelBoardTypeButtonBase {

		public:

			levelBoardTypeButtonFullCube ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardTypeButtonBase ( "button-full-cube-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardTypeButtonFullCube : Initializing full cube button" ) ;
				...
				this -> logger -> logInfo ( "levelBoardTypeButtonFullCube : Initialized full cube button\n" ) ;
			}
