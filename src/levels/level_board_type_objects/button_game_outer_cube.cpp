# ifndef TTT3D_LEVEL_BOARD_TYPE_BUTTON_OUTER_CUBE

	# define TTT3D_LEVEL_BOARD_TYPE_BUTTON_OUTER_CUBE 1
	...
	class levelBoardTypeButtonOuterCube : public levelBoardTypeButtonBase {

		public:

			levelBoardTypeButtonOuterCube ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardTypeButtonBase ( "button-outer-cube-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardTypeButtonOuterCube : Initializing outer cube button" ) ;
				...
				this -> logger -> logInfo ( "levelBoardTypeButtonOuterCube : Initialized outer cube button\n" ) ;
			}
