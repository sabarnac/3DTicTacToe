# ifndef TTT3D_LEVEL_PLAYER_TYPE_BUTTON_THREE_PLAYER

	# define TTT3D_LEVEL_PLAYER_TYPE_BUTTON_THREE_PLAYER 1
	...
	class levelPlayerTypeButtonThreePlayer : public levelPlayerTypeButtonBase {

		public:

			levelPlayerTypeButtonThreePlayer ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelPlayerTypeButtonBase ( "button-three-player-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelPlayerTypeButtonThreePlayer : Initializing three player button" ) ;
				...
				this -> logger -> logInfo ( "levelPlayerTypeButtonThreePlayer : Initialized three player button\n" ) ;
			}
