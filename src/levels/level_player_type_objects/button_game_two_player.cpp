# ifndef TTT3D_LEVEL_PLAYER_TYPE_BUTTON_TWO_PLAYER

	# define TTT3D_LEVEL_PLAYER_TYPE_BUTTON_TWO_PLAYER 1
	...
	class levelPlayerTypeButtonTwoPlayer : public levelPlayerTypeButtonBase {

		public:

			levelPlayerTypeButtonTwoPlayer ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelPlayerTypeButtonBase ( "button-two-player-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelPlayerTypeButtonTwoPlayer : Initializing two player button" ) ;
				...
				this -> logger -> logInfo ( "levelPlayerTypeButtonTwoPlayer : Initialized two player button\n" ) ;
			}
