# ifndef TTT3D_LEVEL_PLAYER_TYPE_BUTTON_TITLE

	# define TTT3D_LEVEL_PLAYER_TYPE_BUTTON_TITLE 1
	...
	class levelPlayerTypeGameTitle : public levelPlayerTypeButtonBase {

		public:

			levelPlayerTypeGameTitle ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelPlayerTypeButtonBase ( "game-title" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelPlayerTypeGameTitle : Initializing game title button" ) ;
				...
				this -> logger -> logInfo ( "levelPlayerTypeGameTitle : Initialized game title button\n" ) ;
			}
