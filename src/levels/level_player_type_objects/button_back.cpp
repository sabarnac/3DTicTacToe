# ifndef TTT3D_LEVEL_PLAYER_TYPE_BUTTON_BACK

	# define TTT3D_LEVEL_PLAYER_TYPE_BUTTON_BACK 1
	...
	class levelPlayerTypeButtonBack : public levelPlayerTypeButtonBase {

		public:

			levelPlayerTypeButtonBack ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelPlayerTypeButtonBase ( "button-back-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelPlayerTypeButtonBack : Initializing back button" ) ;
				...
				this -> logger -> logInfo ( "levelPlayerTypeButtonBack : Initialized back button\n" ) ;
			}
