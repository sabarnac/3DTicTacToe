# ifndef TTT3D_LEVEL_BOARD_CUBE_O

	# define TTT3D_LEVEL_BOARD_CUBE_O 1
	...
	class levelBoardCubeO : public levelBoardCubeBase {

		public:

			levelBoardCubeO ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardCubeBase ( "board-cube-o" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardCubeO : Initializing O board cube" ) ;
				...
				this -> logger -> logInfo ( "levelBoardCubeO : Initialized O board cube\n" ) ;
			}
