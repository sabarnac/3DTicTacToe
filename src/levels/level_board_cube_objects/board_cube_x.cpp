# ifndef TTT3D_LEVEL_BOARD_CUBE_X

	# define TTT3D_LEVEL_BOARD_CUBE_X 1
	...
	class levelBoardCubeX : public levelBoardCubeBase {

		public:

			levelBoardCubeX ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelBoardCubeBase ( "board-cube-x" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelBoardCubeX : Initializing X board cube" ) ;
				...
				this -> logger -> logInfo ( "levelBoardCubeX : Initialized X board cube\n" ) ;
			}
