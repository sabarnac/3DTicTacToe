# ifndef TTT3D_LEVEL_MASTER_BUTTON_PLAY

	# define TTT3D_LEVEL_MASTER_BUTTON_PLAY 1
	...
	class levelMasterButtonPlay : public levelMasterButtonBase {

		public:

			levelMasterButtonPlay ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelMasterButtonBase ( "button-play-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelMasterButtonPlay : Initializing play button" ) ;
				...
				this -> logger -> logInfo ( "levelMasterButtonPlay : Initialized play button\n" ) ;
			}
