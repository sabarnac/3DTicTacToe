# ifndef TTT3D_LEVEL_MASTER_GAME_TITLE

	# define TTT3D_LEVEL_MASTER_GAME_TITLE 1
	...
	class levelMasterGameTitle : public levelMasterButtonBase {

		public:

			levelMasterGameTitle ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelMasterButtonBase ( "game-title" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelMasterGameTitle : Initializing game title button" ) ;
				...
				this -> logger -> logInfo ( "levelMasterGameTitle : Initialized game title button\n" ) ;
			}
