# ifndef TTT3D_LEVEL_MASTER_BUTTON_EXIT

	# define TTT3D_LEVEL_MASTER_BUTTON_EXIT 1
	...
	class levelMasterButtonExit : public levelMasterButtonBase {

		public:

			levelMasterButtonExit ( inputHandler * inputObject , mat4 modelMatrix = mat4 ( 1.0f ) , loggingHandler * logger = new loggingHandler ) : levelMasterButtonBase ( "button-exit-game" , logger ) {
				this -> inputObject = inputObject ;
				
				this -> logger -> logInfo ( "levelMasterButtonExit : Initializing exit button" ) ;
				...
				this -> logger -> logInfo ( "levelMasterButtonExit : Initialized exit button\n" ) ;
			}
